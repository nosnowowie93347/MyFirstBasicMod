...
namespace MyFirstBasicMod.Tiles
{
    ...
    public class PinksTrap : ModTile
    {
        ...
        public override bool Drop(int i, int j)
        {
            ...
            if (style == 0)
                Item.NewItem(i * 16, j * 16, 16, 16, mod.ItemType(Items.Placeable.PinksTrap.PinksTrapA));
            if (style == 1)
                Item.NewItem(i * 16, j * 16, 16, 16, mod.ItemType(Items.Placeable.PinksTrap.PinksTrapB));
