...
{
	public class SylvsDresser : ModTile
	{
		public override void SetDefaults() {
			...
			name.SetDefault("Sylv's Dresser");
			AddMapEntry(new Color(200, 200, 200), name);
			dustType = ModContent.DustType<Sparkle>();
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Dressers };
			dresser = "Sylv's Dresser";
			dresserDrop = ModContent.ItemType<Items.Placeable.SylvsDresser>();
		}
		...
		public override void MouseOverFar(int i, int j) {
			...
			if (chestIndex < 0) {
				...
				if (player.showItemIconText == chest) {
					player.showItemIcon2 = ModContent.ItemType<Items.Placeable.SylvsDresser>();
