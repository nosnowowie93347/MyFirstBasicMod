...
namespace MyFirstBasicMod.Projectiles
{
	public class ExampleFlailProjectile : ModProjectile
	{
		...
		private const string ChainTexturePath = "MyFirstBasicMod/Projectiles/ExampleFlailProjectileChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Joey's Flail Ball"); // Set the projectile name to Example Flail Ball
		}
