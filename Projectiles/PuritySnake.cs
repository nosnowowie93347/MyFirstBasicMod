...
namespace MyFirstBasicMod.Projectiles
{
	...
	{
		public override string Texture => "MyFirstBasicMod/Projectiles/ShadowArm";
		...
		public override void AI() {
			...
			if (projectile.localAI[0] % 10 == 0) {
				PinksPlayer modPlayer = Main.LocalPlayer.GetModPlayer<PinksPlayer>();
		...
		public override void ModifyHitPlayer(Player target, ref int damage, ref bool crit) {
			if (target.hurtCooldowns[1] <= 0) {
				PinksPlayer modPlayer = target.GetModPlayer<PinksPlayer>();
