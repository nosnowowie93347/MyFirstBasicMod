...
namespace MyFirstBasicMod.Projectiles
{
    ...
    public class JoeysFlailProjectile : ModProjectile
    {
        private const string ChainTexturePath = "MyFirstBasicMod/Projectiles/JoeysFlailProjectileChain"; // The folder path to the flail chain sprite
        private const string ChainTextureExtraPath = "MyFirstBasicMod/Projectiles/JoeysFlailProjectileChainExtra";  // This texture and related code is optional and used for a unique effect
