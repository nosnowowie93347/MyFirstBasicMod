...
namespace MyFirstBasicMod.NPCs
{
	...
	class PinkTheTraveller : ModNPC
	{
		...
		public static void UpdateTravelingMerchant() {
			NPC traveler = FindNPC(ModContent.NPCType<PinkTheTraveller>()); // Find an Explorer if there's one spawned in the world
			...
			if (traveler == null && CanSpawnNow()) {
				int newTraveler = NPC.NewNPC(Main.spawnTileX * 16, Main.spawnTileY * 16, ModContent.NPCType<PinkTheTraveller>(), 1); // Spawning at the world spawn
		...
		public static List<Item> CreateNewShop() {
			...
			switch (Main.rand.Next(4)) {
				case 0:
					itemIds.Add(ModContent.ItemType<Items.Placeable.SylvsDoor>());
					break;
				case 1:
					itemIds.Add(ModContent.ItemType<Items.Placeable.PinksBed>());
					break;
				case 2:
					itemIds.Add(ModContent.ItemType<Items.Placeable.PinksChest>());
					break;
				default:
					itemIds.Add(ModContent.ItemType<Items.TerrabotsPickaxe>());
					break;
			}
		...
		public override void HitEffect(int hitDirection, double damage) {
			...
			for (int k = 0; k < num; k++) {
				Dust.NewDust(npc.position, npc.width, npc.height, ModContent.DustType<Dusts.Sparkle>());
			}
		}
		...
		public override string GetChat() {
			...
			switch (Main.rand.Next(4)) {
				...
				case 1:
					return "What's your favorite color? My cousin's favorite colors are Pink and blue.";
				case 2:
					return "I hate it when the corruption invades the world!";
				default:
		...
		public override void NPCLoot() {
			Item.NewItem(npc.getRect(), ModContent.ItemType<Items.Armor.BreastplateName>());
		}
		...
		public override void TownNPCAttackProj(ref int projType, ref int attackDelay) {
			projType = ModContent.ProjectileType<Projectiles.SparklingBall>();
			attackDelay = 1;
		}
