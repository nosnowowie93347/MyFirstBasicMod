...
namespace MyFirstBasicMod.Items.Weapons
{
    public class TrueDiamondStaff : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.useTime = 55; //How long it takes for the item to be used
            Item.useAnimation = 55; //How long the animation of the item takes
        ...
        {
            CreateRecipe()
                .AddIngredient(ItemType<Items.Placeable.GlowingBar>(), 15)
                .AddIngredient(ItemID.DiamondStaff)
                .AddIngredient(ItemType<Items.EpicSoul>(), 6)
