...
namespace MyFirstBasicMod.Items.Armor
{
    ...
    public class TrueSolarFlareHelmet : ModItem
    {
        

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("TRUE Solar Flare Helmet");
        ...
        {
            return body.type == ModContent.ItemType<Items.Armor.TrueSolarFlareChestplate>() && legs.type == ModContent.ItemType<Items.Armor.TrueSolarFlareLeggings>();
        }
        ...
        {
            player.setBonus = "You are awesome!. Full set bonus: +17 defense";
            player.statDefense = (int)(player.statDefense + 17.00);
        ...
        public override void AddRecipes()  //How to craft this item
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<Items.Armor.GodHelmet>(), 1);   //you need 10 Wood
