...
namespace MyFirstBasicMod.Items
{
	...
	public class PinksDrill : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<PinksDrillProjectile>(); // Create the drill projectile
			...
			Item.pick = 300; // How strong the drill is, see https://terraria.wiki.gg/wiki/Pickaxe_power for a list of common values
		}

		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<PinksBar>(12)
