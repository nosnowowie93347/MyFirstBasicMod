...
namespace MyFirstBasicMod.Items
{
	internal class PinksHookItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Pink's Hook");
		}
	...
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("${ProjectileName.GemHookPink}");
		}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor) {
			...
			while (distance > 30f && !float.IsNaN(distance)) {
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/PinksHookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
