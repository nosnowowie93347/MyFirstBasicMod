...
namespace MyFirstBasicMod.Items.Consumables
{
	...
	public class KingOfTheNightBag : ModItem
	{
		...
		public override void ModifyItemLoot(ItemLoot itemLoot) {
			...
			itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<Items.Weapons.ElliesSpear>(), 7));
			itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<Items.Placeable.PinksBar>(), 1, 12, 16));
			itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<KingOfTheNight>()));
		}
	}
}