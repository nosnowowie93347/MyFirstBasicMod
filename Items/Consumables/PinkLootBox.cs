...
namespace MyFirstBasicMod.Items.Consumables
{
    ...
    public class PinkLootBox : ModItem
    {
        ...
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<PinkLootBoxTile>());
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            int[] themedDrops = new int[] {
                ModContent.ItemType<Accessories.GreenRing>(),
                ModContent.ItemType<Accessories.FlashBoots>()
            };
            ...
            IItemDropRule[] oreTypes = new IItemDropRule[] {
                ...
                ItemDropRule.Common(ModContent.ItemType<Placeable.SteelOre>(), 1, 30, 50),
            };
            ...
            IItemDropRule[] oreBars = new IItemDropRule[] {
                ...
                ItemDropRule.Common(ModContent.ItemType<Placeable.PinksBar>(), 1, 10, 21),
            };
            ...
            IItemDropRule[] explorationPotions = new IItemDropRule[] {
                ...
                ItemDropRule.Common(ModContent.ItemType<Consumables.DiamondskinPotion>(), 1, 2, 5),
            };
